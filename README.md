...
- If the discovery answer marks the user as technical, the CLI shows the reviewer catalog before arbitrator selection and lets the user update it for that run with `+Reviewer`, `-Reviewer`, or `only: Reviewer, Reviewer`.
